    ...
    <div class="page-header breadcrumb-wrap">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <div class="credit">
                    <a style="line-height: 0" href="{{route('frontend.variety-samples.show', $varietySample->id)}}" class="notification">
                        <img src="{{ asset('assets/frontend/imgs/Chevron_Left.svg') }}" alt="">
                    </a>
                </div>
                <div class="notification text-center w-100">
                    <h2 class="vss-title">Edit Sample</h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="">
                        <form action="{{ route('frontend.variety-samples.update', $varietySample->id) }}"
                                ...
                                <div class="col-md-6">
                                    <div class="mb-4">
                                        ...
                                        <input type="date" name="sample_date"
                                               ...
                                               id="date"
                                               value="{{ old('sample_date', $varietySample->sample_date) }}">
                                        @error('sample_date')
                            ...
                            <div class="row vss-inputs mb-4">
                                <div class="col-12">
                                    <div class="row">
                                        @foreach(json_decode($varietySample->images, true) ?? [] as $key => $image)
                                            <div class="col-6 vse-image">
                                                <img src="{{ asset($image) }}" alt="Sample Image" class="img-thumbnail mb-2">
