    ...
    <div class="page-header breadcrumb-wrap2">
        <div class="container">
            <div class="d-flex align-items-center">
                <div class="credit">
                    <a style="line-height: 0" href="{{route('frontend.variety-reports.index')}}" class="notification">
                        <img src="{{ asset('assets/frontend/imgs/Chevron_Left.svg') }}" alt="">
                    </a>
                </div>
                <div class="notification text-center w-100">
                    <h2 class="vss-title">{{ $sample->varietyReport->variety_name ?? 'Sample' }}</h2>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="product-detail accordion-detail">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-gallery">
                                    ...
                                    <div class="product-image-slider">
                                        ...
                                        @empty
                                            <figure class="border-radius-10">
                                                <a href="{{ asset('assets/backend/imgs/products/blank_product.png') }}" class="popup-link">
                                                    <img src="{{ asset('assets/backend/imgs/products/blank_product.png') }}" alt="Sample Image">
                                                </a>
                                            </figure>
                                        @endforelse
                                    ...
                                    <div class="slider-nav-thumbnails pl-15 pr-15">
                                        @foreach ($images as $image)
                                            <div>
                                                <img style="cursor: pointer" src="{{ asset($image) }}" alt="Sample Image">
                                            </div>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info">
                                    <div class="d-flex justify-content-between mb-20">
                                        <h2 class="vrs-title">{{ $sample->varietyReport->variety_name ?? 'N/A' }}</h2>
                                        <a href="{{ route('frontend.variety-samples.edit', $sample->id) }}" class="vss-change-btn">
                                            <i class="far fa-pen"></i> Change
                                        </a>
                                    </div>
                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="input-style mb-20">
                                <a href="{{ route('frontend.variety-samples.edit', $sample->id) }}" class="btn vrs-button w-100">
                                    <i class="far fa-pen"></i> Change
                                </a>
                            </div>
                        </div>
