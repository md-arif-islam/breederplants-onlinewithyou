        ...
        <div class="card card-body mb-4">
            ...
            <form action="{{ route('growers.update', $grower->id) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="contact_person" class="form-control" id="contact_person" value="{{ $grower->contact_person }}" placeholder="Enter contact person" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="url" name="website" class="form-control" id="website" value="{{ $grower->website }}" placeholder="Enter website URL">
                    @error('website')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
