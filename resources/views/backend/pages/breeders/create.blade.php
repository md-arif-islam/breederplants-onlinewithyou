        ...
        <div class="card card-body">
            ...
            <form action="{{ route('breeders.store') }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="street" class="form-control" id="street" placeholder="Enter street address"
                           value="{{ old('street') }}">
                    @error('street')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="website" class="form-control" id="website" placeholder="Enter website URL"
                           value="{{ old('website') }}">
                    @error('website')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
