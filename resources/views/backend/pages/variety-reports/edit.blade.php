...
@section('content')
    ...
    <section class="content-main">
        ...
        <div class="card card-body">
            <form action="{{route('variety-reports.update', $varietyReport->id)}}" method="POST"
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-4">
                            ...
                            <input type="text" name="variety_name"
                                   ...
                                   value="{{ old('name', $varietyReport->variety_name) }}"
                    ...
                    <div class="col-md-6">
                        <div class="mb-4">
                                ...
                                @foreach($samplesSchedule as $index => $date)
                                    <div class="input-group mb-2" id="sample-schedule-{{ $index }}">
                                        ...
                                        <button type="button" class="btn btn-danger"
                                                onclick="removeSampleSchedule({{ $index }})">Remove
                                        </button>
                            ...
                            <button type="button" class="btn btn-primary" onclick="addSampleSchedule()">Add Date
                            </button>
                        </div>
