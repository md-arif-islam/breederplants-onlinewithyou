            ...
            <ul class="menu-aside">
                <li class="menu-item active">
                    <a class="menu-link" href="dashboard.html"> <span class="menu-icon">
                            <img src="{{asset('assets/backend/imgs/theme/home.svg')}}" style="filter: brightness(0.3);"
                                 alt="">
                        </span>
                ...
                <li class="menu-item">
                    <a class="menu-link" href="dashboard.html"> <span class="menu-icon">
                            <img src="{{asset('assets/backend/imgs/theme/File_Document.svg')}}"
                                 style="filter: brightness(0.3);" alt="">
                        </span>
                ...
                <li class="menu-item">
                    <a class="menu-link" href="dashboard.html"> <span class="menu-icon">
                            <img src="{{asset('assets/backend/imgs/theme/Growers.svg')}}"
                                 style="filter: brightness(0.3);" alt="">
                        </span>
                ...
                <li class="menu-item">
                    <a class="menu-link" href="dashboard.html"> <span class="menu-icon">
                            <img src="{{asset('assets/backend/imgs/theme/Breeders.svg')}}"
                                 style="filter: brightness(0.3);" alt="">
                        </span>
                ...
                <li class="menu-item">
                    <a class="menu-link" href="dashboard.html"> <span class="menu-icon">
                            <img src="{{asset('assets/backend/imgs/theme/Settings.svg')}}"
                                 style="filter: brightness(0.3);" alt="">
                        </span>
                    ...
                    <li class="dropdown nav-item">
                        <a class="dropdown-toggle" data-bs-toggle="dropdown" href="#" id="dropdownAccount"
                           aria-expanded="false"> <img class="img-xs rounded-circle"
                                                       src="{{asset('assets/backend/imgs/people/user.png')}}"
                                                       alt="User"></a>
                ...
                <div class="col-xl-4 col-lg-6 col-md-12">
                    <div class="card card-product-grid">
                        <a href="#" class="img-wrap"> <img
                                src="{{ asset('assets/backend/imgs/products/product_image.png') }}" alt="Product">
                        </a>
                        <div class="info-wrap">
