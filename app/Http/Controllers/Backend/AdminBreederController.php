...
class AdminBreederController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $user = User::create([
            'email'  => $request->email, 'password' => Hash::make($request->password), 'role' => 'breeder',
    ...
    public function exportCSV()
    {
        ...
        $callback = function() {
            ...
            // Add CSV headers
            fputcsv($handle, [
                'Name', 'Email', 'Phone Number', 'Breeder ID', 'Company Name', 'Street', 'City', 'Postal Code', 'Country', 'Website',
            ]);
