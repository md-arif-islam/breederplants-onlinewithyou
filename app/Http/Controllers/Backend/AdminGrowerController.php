...
class AdminGrowerController extends Controller {
	...
	public function store(Request $request)
	{
		...
		Grower::create([
			...
			'company_email'  => $request->email, // Set the company email
	...
	public function update(Request $request, $id)
	{
		$request->validate([
			...
			'status'         => 'required|string',
			'company_name'   => 'required|string|max:255',
			'company_email'  => 'nullable|string|email|max:255', // Validate as email
			'contact_person' => 'nullable|string|max:255',
			'street'         => 'nullable|string|max:255',
			'city'           => 'nullable|string|max:255',
			'postal_code'    => 'nullable|string|max:255',
		...
		$grower->update([
			'name'           => $request->name,
			'company_name'   => $request->company_name,
			'company_email'  => $request->email, // Update company email
			'contact_person' => $request->contact_person,
			'street'         => $request->street,
			'city'           => $request->city,
			'postal_code'    => $request->postal_code,
