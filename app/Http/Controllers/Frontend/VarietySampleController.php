...
class VarietySampleController extends Controller
{
    ...
    {
        return view('frontend.pages.variety-samples.create', compact('variety_report_id'));
    }

    public function show($id)
    {
        $sample = VarietySample::findOrFail($id);
        return view('frontend.pages.variety-samples.show', compact('sample'));
    }

    public function edit($id)
    {
        $varietySample = VarietySample::findOrFail($id);
        return view('frontend.pages.variety-samples.edit', compact('varietySample'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('frontend.variety-reports.show', ['id' => $varietyReportId])
